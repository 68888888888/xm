    ...
    render () {
      return (
        <div className = "deng">
          ...
          <div className="log">
            <ul>
                <li>
                  ...
                  <input name="loginname" type="text" className="td" placeholder="登录邮箱/手机号码" value={this.state.username} id='username' onChange={this.inputChange} />
                </li>
                <li>
                  <label htmlFor='password'><i className="fa fa-unlock-alt" aria-hidden="true"></i></label>
                  <input name="password" type="password" className="td" placeholder="密码" value={this.state.password} id='password' onChange={this.inputChange} />
                </li>
            </ul>
          </div>
          ...
          <div className="lan">
              <span onClick={this.tiao}><b>免费注册</b></span>
              <p>找回密码</p>
          </div>
          ...
          <div className="otherlogin">
              <span>使用第三方登录</span>
              <ul>
                <li><a href="https://m.mtime.cn/UniteLogin/Dispatch.mi?pid=weibo" title="新浪" className="o_sina"></a></li>
                <li><a href="https://m.mtime.cn/UniteLogin/Dispatch.mi?pid=qq" title="QQ" className="o_qq"></a></li>
              </ul>
          </div>
